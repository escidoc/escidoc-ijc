...
public class FileNotFoundException
    ...
    public FileNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = FileNotFoundException.class;
            Class cE =
    ...
    public FileNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FileNotFoundException.class,
            true);
