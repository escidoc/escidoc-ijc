...
public class IndexNotFoundException
    ...
    public IndexNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = IndexNotFoundException.class;
            Class cE =
    ...
    public IndexNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IndexNotFoundException.class,
            true);
