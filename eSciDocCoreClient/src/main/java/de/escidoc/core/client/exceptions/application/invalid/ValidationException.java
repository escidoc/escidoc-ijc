...
public class ValidationException extends de.escidoc.core.client.exceptions.application.ApplicationException
    implements java.io.Serializable {
    public ValidationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ValidationException.class;
            Class cE =
    ...
    public ValidationException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
