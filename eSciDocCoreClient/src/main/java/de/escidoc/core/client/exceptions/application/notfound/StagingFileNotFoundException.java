...
public class StagingFileNotFoundException
    ...
    public StagingFileNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = StagingFileNotFoundException.class;
            Class cE =
    ...
    public StagingFileNotFoundException(int httpStatusCode,
