...
public class MdRecordNotFoundException
    ...
    public MdRecordNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = MdRecordNotFoundException.class;
            Class cE =
    ...
    public MdRecordNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
