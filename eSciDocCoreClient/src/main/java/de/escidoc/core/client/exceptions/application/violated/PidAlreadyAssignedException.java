...
public class PidAlreadyAssignedException
    ...
    public PidAlreadyAssignedException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = PidAlreadyAssignedException.class;
            Class cE =
    ...
    public PidAlreadyAssignedException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            PidAlreadyAssignedException.class, true);
