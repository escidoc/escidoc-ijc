...
public class OrganizationalUnitHierarchyViolationException
    ...
    public OrganizationalUnitHierarchyViolationException(String message,
        Throwable cause) {
        super(message, cause);
        try {
            Class te = OrganizationalUnitHierarchyViolationException.class;
            Class cE =
    ...
    public OrganizationalUnitHierarchyViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OrganizationalUnitHierarchyViolationException))
            return false;
        OrganizationalUnitHierarchyViolationException other =
            (OrganizationalUnitHierarchyViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            OrganizationalUnitHierarchyViolationException.class, true);
