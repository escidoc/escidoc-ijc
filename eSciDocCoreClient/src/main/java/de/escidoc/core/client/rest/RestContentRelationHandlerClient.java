...
public class RestContentRelationHandlerClient extends RestClientBase {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RestContentRelationHandlerClient.class.getName());
    ...
    public ContentRelationHandler getClient() throws InternalClientException {
        ...
        if (restClient == null) {
            ...
            final ContentRelationRestServiceLocator serviceLocator = new ContentRelationRestServiceLocator();
