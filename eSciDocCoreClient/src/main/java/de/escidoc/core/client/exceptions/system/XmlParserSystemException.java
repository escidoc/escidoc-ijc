...
public class XmlParserSystemException extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public XmlParserSystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = XmlParserSystemException.class;
            Class cE =
    ...
    public XmlParserSystemException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
