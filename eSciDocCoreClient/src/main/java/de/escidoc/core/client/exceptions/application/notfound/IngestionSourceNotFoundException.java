...
public class IngestionSourceNotFoundException
    ...
    public IngestionSourceNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = IngestionSourceNotFoundException.class;
            Class cE =
    ...
    public IngestionSourceNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IngestionSourceNotFoundException))
            return false;
        IngestionSourceNotFoundException other =
            (IngestionSourceNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            IngestionSourceNotFoundException.class, true);
