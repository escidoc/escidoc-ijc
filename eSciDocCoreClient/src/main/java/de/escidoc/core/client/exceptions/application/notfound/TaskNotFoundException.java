...
public class TaskNotFoundException
    ...
    public TaskNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = TaskNotFoundException.class;
            Class cE =
    ...
    public TaskNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TaskNotFoundException.class,
            true);
