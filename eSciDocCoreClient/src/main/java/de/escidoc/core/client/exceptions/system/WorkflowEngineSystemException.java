...
public class WorkflowEngineSystemException
    extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public WorkflowEngineSystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = WorkflowEngineSystemException.class;
            Class cE =
    ...
    public WorkflowEngineSystemException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowEngineSystemException))
            return false;
        WorkflowEngineSystemException other =
            (WorkflowEngineSystemException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            WorkflowEngineSystemException.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://system.exceptions.common.core.escidoc.de",
            "WorkflowEngineSystemException"));
    }
