...
public class WorkflowInstanceNotFoundException
    ...
    public WorkflowInstanceNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowInstanceNotFoundException))
            return false;
        WorkflowInstanceNotFoundException other =
            (WorkflowInstanceNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            WorkflowInstanceNotFoundException.class, true);
