...
public class AdminDescriptorNotFoundException
    ...
    public AdminDescriptorNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AdminDescriptorNotFoundException))
            return false;
        AdminDescriptorNotFoundException other =
            (AdminDescriptorNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            AdminDescriptorNotFoundException.class, true);
