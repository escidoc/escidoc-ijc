...
public class ScopeContextViolationException
    extends
    de.escidoc.core.client.exceptions.application.violated.RuleViolationException
    implements java.io.Serializable {
    public ScopeContextViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ScopeContextViolationException.class;
            Class cE =
    ...
    public ScopeContextViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ScopeContextViolationException))
            return false;
        ScopeContextViolationException other =
            (ScopeContextViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ScopeContextViolationException.class, true);
