...
public class InvalidTripleStoreOutputFormatException
    ...
    public InvalidTripleStoreOutputFormatException(String message,
        Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidTripleStoreOutputFormatException.class;
            Class cE =
    ...
    public InvalidTripleStoreOutputFormatException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidTripleStoreOutputFormatException))
            return false;
        InvalidTripleStoreOutputFormatException other =
            (InvalidTripleStoreOutputFormatException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            InvalidTripleStoreOutputFormatException.class, true);
