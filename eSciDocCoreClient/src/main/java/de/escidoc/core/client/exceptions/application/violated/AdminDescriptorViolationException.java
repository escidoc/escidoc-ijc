...
public class AdminDescriptorViolationException
    ...
    public AdminDescriptorViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AdminDescriptorViolationException.class;
            Class cE =
    ...
    public AdminDescriptorViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AdminDescriptorViolationException))
            return false;
        AdminDescriptorViolationException other =
            (AdminDescriptorViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            AdminDescriptorViolationException.class, true);
