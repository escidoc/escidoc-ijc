...
public class ContentStreamNotFoundException
    ...
    public ContentStreamNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ContentStreamNotFoundException.class;
            Class cE =
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContentStreamNotFoundException))
            return false;
        ContentStreamNotFoundException other =
            (ContentStreamNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ContentStreamNotFoundException.class, true);
