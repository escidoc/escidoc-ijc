...
public class RoleInUseViolationException
    ...
    public RoleInUseViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RoleInUseViolationException.class;
            Class cE =
    ...
    public RoleInUseViolationException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            RoleInUseViolationException.class, true);
