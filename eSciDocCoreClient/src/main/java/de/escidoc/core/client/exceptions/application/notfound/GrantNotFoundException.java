...
public class GrantNotFoundException
    ...
    public GrantNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = GrantNotFoundException.class;
            Class cE =
    ...
    public GrantNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GrantNotFoundException.class,
            true);
