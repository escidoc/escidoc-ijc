...
public class ItemNotFoundException
    ...
    public ItemNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ItemNotFoundException.class;
            Class cE =
    ...
    public ItemNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ItemNotFoundException.class,
            true);
