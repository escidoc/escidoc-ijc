...
public class UserGroupNotFoundException
    extends
    ...
    public UserGroupNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = UserGroupNotFoundException.class;
            Class cE =
    ...
    public UserGroupNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            UserGroupNotFoundException.class, true);
