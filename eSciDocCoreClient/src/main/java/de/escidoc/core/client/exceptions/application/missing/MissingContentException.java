...
public class MissingContentException
    ...
    public MissingContentException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = MissingContentException.class;
            Class cE =
    ...
    public MissingContentException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MissingContentException.class,
            true);
