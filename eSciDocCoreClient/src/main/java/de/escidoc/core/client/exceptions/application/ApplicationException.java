...
public abstract class ApplicationException extends de.escidoc.core.client.exceptions.EscidocException
    implements java.io.Serializable {
    public ApplicationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ApplicationException.class;
            Class cE =
    ...
    public ApplicationException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
