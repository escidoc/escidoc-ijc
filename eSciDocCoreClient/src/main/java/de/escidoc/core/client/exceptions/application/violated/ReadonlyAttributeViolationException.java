...
public class ReadonlyAttributeViolationException
    extends
    de.escidoc.core.client.exceptions.application.violated.ReadonlyViolationException
    implements java.io.Serializable {
    public ReadonlyAttributeViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ReadonlyAttributeViolationException.class;
            Class cE =
    ...
    public ReadonlyAttributeViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReadonlyAttributeViolationException))
            return false;
        ReadonlyAttributeViolationException other =
            (ReadonlyAttributeViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ReadonlyAttributeViolationException.class, true);
