...
public class ReadonlyAttributeViolationException
    extends de.escidoc.core.client.exceptions.application.violated.ReadonlyViolationException
    ...
    public ReadonlyAttributeViolationException(int httpStatusCode, java.lang.String httpStatusLine,
