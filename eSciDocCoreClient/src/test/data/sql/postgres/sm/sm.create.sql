...
INSERT INTO sm.report_definitions (id, xml_data, scope_id, name) VALUES ('escidoc:repdef2', '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="escidoc:repdef2">	<name>Unsuccessful Framework Requests</name>  <scope objid="escidoc:scope1" />	<sql>		select * 		from _escidocaggdef2_error_statistics;	</sql><allowed-roles><allowed-role objid="default-user" /></allowed-roles></report-definition>', 'escidoc:scope1', 'Unsuccessful Framework Requests');
...
INSERT INTO sm.report_definitions (id, xml_data, scope_id, name) VALUES ('escidoc:repdef4', '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="escidoc:repdef4">	<name>Item retrievals, all users</name>  <scope objid="escidoc:scope2" />	<sql>		select object_id as itemid, sum(requests) as itemrequests		from _escidocaggdef1_object_statistics		where object_id = {object_id} and handler=''de.escidoc.core.om.service.ItemHandler'' and request=''retrieve'' group by object_id;	</sql><allowed-roles><allowed-role objid="default-user" /></allowed-roles></report-definition>', 'escidoc:scope2', 'Item retrievals, all users');
...
INSERT INTO sm.report_definitions (id, xml_data, scope_id, name) VALUES ('escidoc:repdef7', '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="escidoc:repdef7">	<name>Item retrievals, anonymous users</name>  <scope objid="escidoc:scope2" />	<sql>		select object_id as itemid, sum(requests) as itemrequests		from _escidocaggdef1_object_statistics		where object_id = {object_id} and handler=''de.escidoc.core.om.service.ItemHandler'' and request=''retrieve'' and user_id='''' group by object_id;	</sql><allowed-roles><allowed-role objid="default-user" /></allowed-roles></report-definition>', 'escidoc:scope2', 'Item retrievals, anonymous users');
