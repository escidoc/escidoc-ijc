...
public class SRWSampleServiceLocator extends org.apache.axis.client.Service implements gov.loc.www.zing.srw.service.SRWSampleService {
    ...
    private java.lang.String SRW_address = "http://localhost:8080/srw/search/escidoc_all?wsdl";
    ...
    public gov.loc.www.zing.srw.service.SRWPort getSRW(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.loc.www.zing.srw.service.SRWSoapBindingStub _stub = new gov.loc.www.zing.srw.service.SRWSoapBindingStub(portAddress, this);
    ...
    private java.lang.String ExplainSOAP_address = "http://localhost:8080/srw/search/escidoc_all?wsdl";
    ...
    public gov.loc.www.zing.srw.service.ExplainPort getExplainSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.loc.www.zing.srw.service.ExplainSOAPSoapBindingStub _stub = new gov.loc.www.zing.srw.service.ExplainSOAPSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.loc.www.zing.srw.service.SRWPort.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.loc.www.zing.srw.service.SRWSoapBindingStub _stub = new gov.loc.www.zing.srw.service.SRWSoapBindingStub(new java.net.URL(SRW_address), this);
                _stub.setPortName(getSRWWSDDServiceName());
                return _stub;
            }
            if (gov.loc.www.zing.srw.service.ExplainPort.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.loc.www.zing.srw.service.ExplainSOAPSoapBindingStub _stub = new gov.loc.www.zing.srw.service.ExplainSOAPSoapBindingStub(new java.net.URL(ExplainSOAP_address), this);
                _stub.setPortName(getExplainSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/service/", "SRW"));
            ports.add(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/service/", "ExplainSOAP"));
        }
