...
/**
 * Properties of the eSciDoc resources.
 * 
 * @author SWA
 * 
 */
public class PropertiesVersioned extends Properties
    implements VersionableResourcePropertiesInterface {
