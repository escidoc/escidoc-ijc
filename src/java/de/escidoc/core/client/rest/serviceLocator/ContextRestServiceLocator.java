 ...
 * 
 */
public class ContextRestServiceLocator extends RestServiceMethod implements
		ContextHandler {
	...
	public String retrieveAdminDescriptor(final String contextId,
			final String admId) throws RemoteException, SystemException,
