package de.escidoc.core.test.client.unitTests.marshalling.common;
...
public class TaskParamMarshallerTest extends MarshallerTestBase<TaskParam> {
     ...
     * @throws SAXException
     */
    public TaskParamMarshallerTest() throws IOException, ParserConfigurationException, SAXException {
        super(TaskParam.class, BASE, XSD, "task-param_complete.xml");
    }
