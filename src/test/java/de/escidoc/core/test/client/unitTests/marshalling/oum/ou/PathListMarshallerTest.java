...
public class PathListMarshallerTest extends MarshallerTestBase<PathList> {
     ...
     * @throws SAXException
     */
    public PathListMarshallerTest() throws IOException, ParserConfigurationException, SAXException {
        super(PathList.class, BASE, XSD, "pathlist_complete.xml");
    }
