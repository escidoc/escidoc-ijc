package de.escidoc.core.test.client.sb;
    ...
    public void testSearch2() throws Exception {
        ...
        if (records != null) {
            for (int i = 0; i < records.length; i++) {
                ...
                MyStringFragmentSearch stringFragment =
                    record.getStringFragment();
                SearchResultRecord resultrecord =
                    stringFragment.getResultRecord();
                ...
                if (content instanceof Item) {
                    ...
                    Marshaller<SearchResultRecord> m =
                        new Marshaller<SearchResultRecord>(resultrecord
                            .getClass());
