...
public class OuCreateTest extends EscidocClientTestBase {
	...
	public void testCreateOrganizationalUnit01() throws Exception {
		...
		OrganizationalUnitHandlerClient cc = new OrganizationalUnitHandlerClient();
	...
	public void testMultipleMetadataRecords01() throws Exception {
		...
		Element childElement = doc.createElementNS(
				"http://purl.org/dc/elements/1.1/", "cd:title");
		...
		OrganizationalUnit createdOrganizationalUnit = cc
		...
		OrganizationalUnit updatedOrganizationalUnit1 = cc
				.update(createdOrganizationalUnit);
