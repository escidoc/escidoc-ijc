...
public class GrantsTest {
	...
	public void testCreateGrant02() throws Exception {
		...
		assertEquals("Missing Assigned-On", createdItem.getObjid(), grants
				.getGrants().iterator().next().getGrantProperties()
				.getAssignedOn().getObjid());
	}
	...
	public void testRevokeGrant01() throws Exception {
		...
		assertEquals("Revoked by differs", uahc.retrieveCurrentUser()
				.getObjid(), revokedGrant.getGrantProperties().getRevokedBy()
				.getObjid());
	}
