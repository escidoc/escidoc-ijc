...
public abstract class Resource extends XLinkResource {
	...
	public static enum RESOURCE_TYPE {
		...
		Context(true, "context"), Item(true, "item"), Container(true,
				...
				"content-relation"), Scope(true, "scope"),
				ReportDefinition(true, "reportDefinition"), 
		// sub resources
	...
	public static final Map<RESOURCE_TYPE, String> RESOURCE_URL_MAP = new HashMap<RESOURCE_TYPE, String>();
	{
	 ...
	 */
	protected static final String genXLinkHref(final Resource resource,
