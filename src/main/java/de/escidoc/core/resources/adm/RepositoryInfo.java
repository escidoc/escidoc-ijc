...
public class RepositoryInfo extends Properties {
    ...
    public static final String KEY_SCHEMA_ORGANIZATIONAL_UNIT =
        "organizational-unit";
    ...
    public static final String KEY_ESCIDOC_CORE_EARLIEST_DATE =
        "escidoc-core.earliest-date";

    public static final String KEY_ESCIDOC_CORE_BASEURL =
        "escidoc-core.baseurl";

    public static final String KEY_ESCIDOC_CORE_DATABASE_VERSION =
        "escidoc-core.database.version";

    public static final String KEY_ESCIDOC_CORE_ADMIN_EMAIL =
    ...
    public static final String KEY_ESCIDOC_CORE_DATABASE_CONSISTENT =
        "escidoc-core.database.consistent";

    public static final String KEY_ESCIDOC_CORE_BUILD = "escidoc-core.build";

    public static final String KEY_ESCIDOC_CORE_REPOSITORY_NAME =
