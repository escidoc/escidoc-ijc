...
public class SoapContainerHandlerClient extends SoapClientBase {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SoapContainerHandlerClient.class);
    ...
    public ContainerHandler getClient() throws InternalClientException {
        ...
        try {
            if (soapClient == null) {
                final ContainerHandlerServiceLocator serviceLocator =
                    new ContainerHandlerServiceLocator(getEngineConfig());
                final URL url = getHandlerServiceURL(serviceLocator.getContainerHandlerServiceAddress());
