...
public class UserAttributeNotFoundException
    extends
    de.escidoc.core.client.exceptions.application.notfound.ResourceNotFoundException
    implements java.io.Serializable {
    public UserAttributeNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = UserAttributeNotFoundException.class;
            Class cE =
    ...
    public UserAttributeNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UserAttributeNotFoundException))
            return false;
        UserAttributeNotFoundException other =
            (UserAttributeNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            UserAttributeNotFoundException.class, true);
