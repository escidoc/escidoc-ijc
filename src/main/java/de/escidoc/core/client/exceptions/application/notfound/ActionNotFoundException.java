...
public class ActionNotFoundException
    ...
    public ActionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ActionNotFoundException.class;
            Class cE =
    ...
    public ActionNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ActionNotFoundException.class,
            true);
