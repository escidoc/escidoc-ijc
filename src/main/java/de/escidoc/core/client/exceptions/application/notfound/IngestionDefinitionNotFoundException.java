...
public class IngestionDefinitionNotFoundException
    ...
    public IngestionDefinitionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = IngestionDefinitionNotFoundException.class;
            Class cE =
    ...
    public IngestionDefinitionNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IngestionDefinitionNotFoundException))
            return false;
        IngestionDefinitionNotFoundException other =
            (IngestionDefinitionNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            IngestionDefinitionNotFoundException.class, true);
