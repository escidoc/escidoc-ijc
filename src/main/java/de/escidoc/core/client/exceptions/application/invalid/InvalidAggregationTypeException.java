...
public class InvalidAggregationTypeException
    ...
    public InvalidAggregationTypeException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidAggregationTypeException.class;
            Class cE =
    ...
    public InvalidAggregationTypeException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidAggregationTypeException))
            return false;
        InvalidAggregationTypeException other =
            (InvalidAggregationTypeException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            InvalidAggregationTypeException.class, true);
