...
public class RoleNotFoundException
    ...
    public RoleNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RoleNotFoundException.class;
            Class cE =
    ...
    public RoleNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RoleNotFoundException.class,
            true);
