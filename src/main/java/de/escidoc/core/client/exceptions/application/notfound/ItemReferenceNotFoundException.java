...
public class ItemReferenceNotFoundException
    ...
    public ItemReferenceNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ItemReferenceNotFoundException.class;
            Class cE =
    ...
    public ItemReferenceNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ItemReferenceNotFoundException))
            return false;
        ItemReferenceNotFoundException other =
            (ItemReferenceNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ItemReferenceNotFoundException.class, true);
