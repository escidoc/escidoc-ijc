...
public class TargetBasketNotFoundException
    extends
    de.escidoc.core.client.exceptions.application.notfound.ResourceNotFoundException
    implements java.io.Serializable {
    public TargetBasketNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = TargetBasketNotFoundException.class;
            Class cE =
    ...
    public TargetBasketNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TargetBasketNotFoundException))
            return false;
        TargetBasketNotFoundException other =
            (TargetBasketNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            TargetBasketNotFoundException.class, true);
