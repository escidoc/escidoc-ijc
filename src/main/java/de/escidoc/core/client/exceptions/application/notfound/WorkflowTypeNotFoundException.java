...
public class WorkflowTypeNotFoundException
    ...
    public WorkflowTypeNotFoundException(int httpStatusCode, java.lang.String httpStatusLine,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://notfound.application.exceptions.common.core.escidoc.de", "WorkflowTypeNotFoundException"));
    }
