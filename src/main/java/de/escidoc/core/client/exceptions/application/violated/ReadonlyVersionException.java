...
public class ReadonlyVersionException
    ...
    public ReadonlyVersionException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ReadonlyVersionException.class;
            Class cE =
    ...
    public ReadonlyVersionException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
