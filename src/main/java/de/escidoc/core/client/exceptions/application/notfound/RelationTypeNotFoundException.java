...
public class RelationTypeNotFoundException
    ...
    public RelationTypeNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RelationTypeNotFoundException.class;
            Class cE =
    ...
    public RelationTypeNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RelationTypeNotFoundException))
            return false;
        RelationTypeNotFoundException other =
            (RelationTypeNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            RelationTypeNotFoundException.class, true);
