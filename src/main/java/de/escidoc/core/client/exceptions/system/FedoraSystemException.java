...
public class FedoraSystemException extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public FedoraSystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = FedoraSystemException.class;
            Class cE =
    ...
    public FedoraSystemException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
