...
public class UniqueConstraintViolationException
    ...
    public UniqueConstraintViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = UniqueConstraintViolationException.class;
            Class cE =
    ...
    public UniqueConstraintViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UniqueConstraintViolationException))
            return false;
        UniqueConstraintViolationException other =
            (UniqueConstraintViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            UniqueConstraintViolationException.class, true);
