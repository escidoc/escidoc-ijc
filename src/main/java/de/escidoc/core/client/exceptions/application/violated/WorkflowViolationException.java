...
public class WorkflowViolationException
    extends
    de.escidoc.core.client.exceptions.application.violated.RuleViolationException
    implements java.io.Serializable {
    public WorkflowViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = WorkflowViolationException.class;
            Class cE =
    ...
    public WorkflowViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowViolationException))
            return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            WorkflowViolationException.class, true);
