...
public class MissingLicenceException
    ...
    public MissingLicenceException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = MissingLicenceException.class;
            Class cE =
    ...
    public MissingLicenceException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MissingLicenceException.class,
            true);
