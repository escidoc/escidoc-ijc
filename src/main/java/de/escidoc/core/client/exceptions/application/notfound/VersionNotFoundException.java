...
public class VersionNotFoundException
    ...
    public VersionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = VersionNotFoundException.class;
            Class cE =
    ...
    public VersionNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
