...
public class TmeException extends de.escidoc.core.client.exceptions.application.ApplicationException
    ...
    public TmeException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
