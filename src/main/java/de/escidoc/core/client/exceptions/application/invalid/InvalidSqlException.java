...
public class InvalidSqlException extends de.escidoc.core.client.exceptions.application.invalid.ValidationException
    implements java.io.Serializable {
    public InvalidSqlException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidSqlException.class;
            Class cE =
    ...
    public InvalidSqlException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
