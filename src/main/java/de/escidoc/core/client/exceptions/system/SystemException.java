...
public class SystemException extends de.escidoc.core.client.exceptions.EscidocException implements java.io.Serializable {
    public SystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = SystemException.class;
            Class cE =
    ...
    public SystemException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
