...
public class TimeFrameViolationException
    extends
    de.escidoc.core.client.exceptions.application.violated.RuleViolationException
    implements java.io.Serializable {
    public TimeFrameViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = TimeFrameViolationException.class;
            Class cE =
    ...
    public TimeFrameViolationException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            TimeFrameViolationException.class, true);
