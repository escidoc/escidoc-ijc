...
public class AggregationTypeNotFoundException
    ...
    public AggregationTypeNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AggregationTypeNotFoundException.class;
            Class cE =
    ...
    public AggregationTypeNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AggregationTypeNotFoundException))
            return false;
        AggregationTypeNotFoundException other =
            (AggregationTypeNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            AggregationTypeNotFoundException.class, true);
