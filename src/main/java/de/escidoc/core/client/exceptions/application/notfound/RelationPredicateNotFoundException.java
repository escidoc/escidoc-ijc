...
public class RelationPredicateNotFoundException
    ...
    public RelationPredicateNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RelationPredicateNotFoundException.class;
            Class cE =
    ...
    public RelationPredicateNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RelationPredicateNotFoundException))
            return false;
        RelationPredicateNotFoundException other =
            (RelationPredicateNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            RelationPredicateNotFoundException.class, true);
