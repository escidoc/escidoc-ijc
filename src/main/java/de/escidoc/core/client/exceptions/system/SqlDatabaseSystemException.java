...
public class SqlDatabaseSystemException extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public SqlDatabaseSystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = SqlDatabaseSystemException.class;
            Class cE =
    ...
    public SqlDatabaseSystemException(int httpStatusCode, java.lang.String httpStatusLine,
