...
public class RevisionNotFoundException
    ...
    public RevisionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RevisionNotFoundException.class;
            Class cE =
    ...
    public RevisionNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
