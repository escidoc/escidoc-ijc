...
public class AlreadyPublishedException
    ...
    public AlreadyPublishedException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AlreadyPublishedException.class;
            Class cE =
    ...
    public AlreadyPublishedException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
