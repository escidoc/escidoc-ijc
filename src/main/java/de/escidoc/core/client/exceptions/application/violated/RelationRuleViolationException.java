...
public class RelationRuleViolationException
    ...
    public RelationRuleViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RelationRuleViolationException.class;
            Class cE =
    ...
    public RelationRuleViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RelationRuleViolationException))
            return false;
        RelationRuleViolationException other =
            (RelationRuleViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            RelationRuleViolationException.class, true);
