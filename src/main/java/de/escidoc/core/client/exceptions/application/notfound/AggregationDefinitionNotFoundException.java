...
public class AggregationDefinitionNotFoundException
    ...
    public AggregationDefinitionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
    ...
    public AggregationDefinitionNotFoundException(int httpStatusCode, java.lang.String httpStatusLine,
