...
public class AggregationDefinitionNotFoundException
    ...
    public AggregationDefinitionNotFoundException(String message,
        Throwable cause) {
        super(message, cause);
        try {
            Class te = AggregationDefinitionNotFoundException.class;
            Class cE =
    ...
    public AggregationDefinitionNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AggregationDefinitionNotFoundException))
            return false;
        AggregationDefinitionNotFoundException other =
            (AggregationDefinitionNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            AggregationDefinitionNotFoundException.class, true);
