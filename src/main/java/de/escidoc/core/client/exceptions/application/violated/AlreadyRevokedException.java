...
public class AlreadyRevokedException
    ...
    public AlreadyRevokedException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AlreadyRevokedException.class;
            Class cE =
    ...
    public AlreadyRevokedException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlreadyRevokedException.class,
            true);
