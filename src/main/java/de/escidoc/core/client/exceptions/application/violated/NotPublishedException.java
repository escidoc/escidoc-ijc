...
public class NotPublishedException
    ...
    public NotPublishedException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = NotPublishedException.class;
            Class cE =
    ...
    public NotPublishedException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NotPublishedException.class,
            true);
