...
public class InvalidXmlException extends de.escidoc.core.client.exceptions.application.invalid.ValidationException
    implements java.io.Serializable {
    public InvalidXmlException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidXmlException.class;
            Class cE =
    ...
    public InvalidXmlException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
