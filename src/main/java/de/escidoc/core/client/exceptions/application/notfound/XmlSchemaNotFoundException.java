...
public class XmlSchemaNotFoundException
    extends
    de.escidoc.core.client.exceptions.application.notfound.ResourceNotFoundException
    implements java.io.Serializable {
    public XmlSchemaNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = XmlSchemaNotFoundException.class;
            Class cE =
    ...
    public XmlSchemaNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            XmlSchemaNotFoundException.class, true);
