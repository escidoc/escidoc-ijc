...
public class InvalidWorkflowTypeException
    ...
    public InvalidWorkflowTypeException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidWorkflowTypeException.class;
            Class cE =
    ...
    public InvalidWorkflowTypeException(int httpStatusCode, java.lang.String httpStatusLine,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidWorkflowTypeException))
            return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://invalid.application.exceptions.common.core.escidoc.de", "InvalidWorkflowTypeException"));
    }
