...
public class RelationNotFoundException
    ...
    public RelationNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RelationNotFoundException.class;
            Class cE =
    ...
    public RelationNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
