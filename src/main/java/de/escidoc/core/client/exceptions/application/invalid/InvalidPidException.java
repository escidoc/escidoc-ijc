...
public class InvalidPidException extends de.escidoc.core.client.exceptions.application.invalid.ValidationException
    implements java.io.Serializable {
    public InvalidPidException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidPidException.class;
            Class cE =
    ...
    public InvalidPidException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
