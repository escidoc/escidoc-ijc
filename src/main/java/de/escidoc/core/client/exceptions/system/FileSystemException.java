...
public class FileSystemException extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public FileSystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = FileSystemException.class;
            Class cE =
    ...
    public FileSystemException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
