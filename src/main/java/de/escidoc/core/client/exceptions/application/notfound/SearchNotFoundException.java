...
public class SearchNotFoundException
    ...
    public SearchNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = SearchNotFoundException.class;
            Class cE =
    ...
    public SearchNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SearchNotFoundException.class,
            true);
