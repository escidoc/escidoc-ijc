...
public class ReadonlyElementViolationException
    ...
    public ReadonlyElementViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ReadonlyElementViolationException.class;
            Class cE =
    ...
    public ReadonlyElementViolationException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReadonlyElementViolationException))
            return false;
        ReadonlyElementViolationException other =
            (ReadonlyElementViolationException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ReadonlyElementViolationException.class, true);
