...
public class InvalidContentModelException
    ...
    public InvalidContentModelException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidContentModelException.class;
            Class cE =
    ...
    public InvalidContentModelException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            InvalidContentModelException.class, true);
