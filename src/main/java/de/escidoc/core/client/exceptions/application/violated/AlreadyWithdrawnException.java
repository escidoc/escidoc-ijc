...
public class AlreadyWithdrawnException
    ...
    public AlreadyWithdrawnException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AlreadyWithdrawnException.class;
            Class cE =
    ...
    public AlreadyWithdrawnException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
