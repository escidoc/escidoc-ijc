...
public class IngestionTaskNotFoundException
    ...
    public IngestionTaskNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = IngestionTaskNotFoundException.class;
            Class cE =
    ...
    public IngestionTaskNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IngestionTaskNotFoundException))
            return false;
        IngestionTaskNotFoundException other =
            (IngestionTaskNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            IngestionTaskNotFoundException.class, true);
