...
public class TaskListNotFoundException
    ...
    public TaskListNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = TaskListNotFoundException.class;
            Class cE =
    ...
    public TaskListNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
