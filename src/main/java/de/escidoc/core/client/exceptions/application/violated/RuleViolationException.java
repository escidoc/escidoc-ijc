...
public class RuleViolationException extends de.escidoc.core.client.exceptions.application.ApplicationException
    implements java.io.Serializable {
    public RuleViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = RuleViolationException.class;
            Class cE =
    ...
    public RuleViolationException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
