...
public class TripleStoreSystemException extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public TripleStoreSystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = TripleStoreSystemException.class;
            Class cE =
    ...
    public TripleStoreSystemException(int httpStatusCode, java.lang.String httpStatusLine,
