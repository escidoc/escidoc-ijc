...
public class ResourceInUseException extends de.escidoc.core.client.exceptions.application.ApplicationException
    implements java.io.Serializable {
    public ResourceInUseException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ResourceInUseException.class;
            Class cE =
    ...
    public ResourceInUseException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
