...
public class AuthorizationException extends de.escidoc.core.client.exceptions.application.security.SecurityException
    implements java.io.Serializable {
    public AuthorizationException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AuthorizationException.class;
            Class cE =
    ...
    public AuthorizationException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg,
