...
public class ResourceNotFoundException extends de.escidoc.core.client.exceptions.application.ApplicationException
    implements java.io.Serializable {
    public ResourceNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ResourceNotFoundException.class;
            Class cE =
    ...
    public ResourceNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
