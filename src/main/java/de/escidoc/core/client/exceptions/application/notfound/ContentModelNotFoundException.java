...
public class ContentModelNotFoundException
    ...
    public ContentModelNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ContentModelNotFoundException.class;
            Class cE =
    ...
    public ContentModelNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContentModelNotFoundException))
            return false;
        ContentModelNotFoundException other =
            (ContentModelNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ContentModelNotFoundException.class, true);
