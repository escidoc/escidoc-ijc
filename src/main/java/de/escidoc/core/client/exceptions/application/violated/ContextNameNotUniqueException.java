...
public class ContextNameNotUniqueException
    ...
    public ContextNameNotUniqueException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ContextNameNotUniqueException.class;
            Class cE =
    ...
    public ContextNameNotUniqueException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContextNameNotUniqueException))
            return false;
        ContextNameNotUniqueException other =
            (ContextNameNotUniqueException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ContextNameNotUniqueException.class, true);
