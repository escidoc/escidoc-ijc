...
public class InvalidContextStatusException
    ...
    public InvalidContextStatusException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = InvalidContextStatusException.class;
            Class cE =
    ...
    public InvalidContextStatusException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidContextStatusException))
            return false;
        InvalidContextStatusException other =
            (InvalidContextStatusException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            InvalidContextStatusException.class, true);
