...
public class ContextNotFoundException
    ...
    public ContextNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ContextNotFoundException.class;
            Class cE =
    ...
    public ContextNotFoundException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
