...
public class OrganizationalUnitHierarchyViolationException
    ...
    public OrganizationalUnitHierarchyViolationException(String message, Throwable cause) {
        super(message, cause);
        try {
    ...
    public OrganizationalUnitHierarchyViolationException(int httpStatusCode, java.lang.String httpStatusLine,
