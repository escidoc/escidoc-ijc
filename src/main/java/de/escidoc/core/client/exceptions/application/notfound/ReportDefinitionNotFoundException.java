...
public class ReportDefinitionNotFoundException
    ...
    public ReportDefinitionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ReportDefinitionNotFoundException.class;
            Class cE =
    ...
    public ReportDefinitionNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReportDefinitionNotFoundException))
            return false;
        ReportDefinitionNotFoundException other =
            (ReportDefinitionNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ReportDefinitionNotFoundException.class, true);
