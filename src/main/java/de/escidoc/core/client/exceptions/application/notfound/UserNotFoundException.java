...
public class UserNotFoundException
    ...
    public UserNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = UserNotFoundException.class;
            Class cE =
    ...
    public UserNotFoundException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UserNotFoundException.class,
            true);
