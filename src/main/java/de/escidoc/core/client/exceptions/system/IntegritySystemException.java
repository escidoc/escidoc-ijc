...
public class IntegritySystemException extends de.escidoc.core.client.exceptions.system.SystemException
    implements java.io.Serializable {
    public IntegritySystemException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = IntegritySystemException.class;
            Class cE =
    ...
    public IntegritySystemException(int httpStatusCode, java.lang.String httpStatusLine, java.lang.String httpStatusMsg) {
