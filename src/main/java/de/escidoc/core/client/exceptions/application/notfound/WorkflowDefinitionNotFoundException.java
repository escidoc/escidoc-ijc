...
public class WorkflowDefinitionNotFoundException
    ...
    public WorkflowDefinitionNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowDefinitionNotFoundException))
            return false;
        WorkflowDefinitionNotFoundException other =
            (WorkflowDefinitionNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            WorkflowDefinitionNotFoundException.class, true);
