...
public class WorkflowDefinitionNotFoundException
    ...
    public WorkflowDefinitionNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = WorkflowDefinitionNotFoundException.class;
            Class cE =
    ...
    public WorkflowDefinitionNotFoundException(int httpStatusCode, java.lang.String httpStatusLine,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowDefinitionNotFoundException))
            return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(
            "http://notfound.application.exceptions.common.core.escidoc.de", "WorkflowDefinitionNotFoundException"));
    }
