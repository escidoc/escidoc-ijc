...
import java.lang.reflect.Field; public class StreamNotFoundException  extends de.escidoc.core.client.exceptions.EscidocException  implements java.io.Serializable { public StreamNotFoundException(String message, Throwable cause) {super(message, cause);try {Class te = StreamNotFoundException.class;Class cE =Class.forName(te.getName().replace("de.escidoc.core.client.exceptions","de.escidoc.core.common.exceptions.remote"));Field[] tF = te.getDeclaredFields();Field[] cF = cE.getDeclaredFields();for (int i = 0; i < tF.length; ++i) {tF[i].setAccessible(true);cF[i].setAccessible(true);tF[i].set(this, cF[i].get(cause));}} catch (Exception e) { throw new RuntimeException(e);}}
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StreamNotFoundException)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://notfound.application.exceptions.common.core.escidoc.de", "StreamNotFoundException"));
    }
