...
public class OrganizationalUnitNotFoundException
    ...
    public OrganizationalUnitNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = OrganizationalUnitNotFoundException.class;
            Class cE =
    ...
    public OrganizationalUnitNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OrganizationalUnitNotFoundException))
            return false;
        OrganizationalUnitNotFoundException other =
            (OrganizationalUnitNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            OrganizationalUnitNotFoundException.class, true);
