...
public class ContentRelationNotFoundException
    ...
    public ContentRelationNotFoundException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = ContentRelationNotFoundException.class;
            Class cE =
    ...
    public ContentRelationNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContentRelationNotFoundException))
            return false;
        ContentRelationNotFoundException other =
            (ContentRelationNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            ContentRelationNotFoundException.class, true);
