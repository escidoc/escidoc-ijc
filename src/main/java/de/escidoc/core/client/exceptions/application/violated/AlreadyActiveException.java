...
public class AlreadyActiveException
    ...
    public AlreadyActiveException(String message, Throwable cause) {
        super(message, cause);
        try {
            Class te = AlreadyActiveException.class;
            Class cE =
    ...
    public AlreadyActiveException(int httpStatusCode,
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlreadyActiveException.class,
            true);
