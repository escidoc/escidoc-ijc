...
public class WorkflowTemplateNotFoundException
    ...
    public WorkflowTemplateNotFoundException(int httpStatusCode,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowTemplateNotFoundException))
            return false;
        WorkflowTemplateNotFoundException other =
            (WorkflowTemplateNotFoundException) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(
            WorkflowTemplateNotFoundException.class, true);
